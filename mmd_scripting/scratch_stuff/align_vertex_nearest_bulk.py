...
def main():
	...
	rawlist_vertex_source = nhio.read_file_to_csvlist(input_filename_vertex_source, use_jis_encoding=True)
	...
	rawlist_vertex_dest = nhio.read_file_to_csvlist(input_filename_vertex_dest, use_jis_encoding=True)
	...
	# export modified CSV
	nhio.write_csvlist_to_file(output_filename, rawlist_vertex_source, use_jis_encoding=True)
